...
rise_res <- run_rise_pipeline(
  ...
  figure_path = fs::path(figure_path, "rise_rvsv_prevac_screening_evaluation.pdf")
)
...
# Saved for analysis/supplementary/significant_markers_table_rvsv.R,
...
saveRDS(
  ...
  fs::path(results_path, "screening_rvsv.rds")
)
