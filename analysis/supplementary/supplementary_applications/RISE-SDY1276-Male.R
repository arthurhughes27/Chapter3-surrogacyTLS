...
# train/test), restricted to sex == "Male" instead of the main
# application's sex == "Female" - otherwise identical to
# analysis/application/RISE-SDY1276.R.
...
saveRDS(markers, fs::path(results_path, "TLS_TIV_SDY1276_Male.rds"))

# Saved for a future significant_markers_table_sdy1276_male.R, matching
# analysis/supplementary/significant_markers_table_sdy1276.R for the main
# (Female) application.
saveRDS(
  ...
  fs::path(results_path, "screening_sdy1276_male.rds")
)
...
# NOTE: DAVID over-representation results (analogous to the main,
# Female SDY1276 application) are not yet available for this Male
# subgroup; the DAVID_SDY1276_Male.csv import/table has been skipped
