# Supplementary. Data generation process 2 (complex), scenario 2:
# empirical power and false discovery proportion prior to multiple
# testing correction, as a function of average surrogate strength (U_S
# bar), for three different sample sizes.
...
results_path <- fs::path(output_path, "results", "supplementary", "power_fdr_vs_strength_complex_dgp.rds")
figure_path <- fs::path(output_path, "figures", "supplementary", "power_fdr_vs_strength_complex_dgp")
