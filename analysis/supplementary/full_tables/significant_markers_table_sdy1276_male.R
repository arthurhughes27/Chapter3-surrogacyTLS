...
#
# Requires analysis/supplementary/supplementary_applications/RISE-SDY1276-Male.R
# to have been run first, since it depends on that script's saved
# screening_sdy1276_male.rds.
